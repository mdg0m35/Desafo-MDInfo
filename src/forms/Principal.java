...
public class Principal extends JFrame {
	...
	public Principal() {
		...
		Logofundo.setIcon(new ImageIcon("C:\\Users\\Marcos David\\Documents\\NetBeansProjects\\MdInfo\\src\\imagens\\text (2).png"));
		...
		Logo2.setIcon(new ImageIcon("C:\\Users\\Marcos David\\Documents\\NetBeansProjects\\MdInfo\\src\\imagens\\text (2).png"));
		...
		tableDados.setBounds(81, 46, 713, 290);
		panel6.add(tableDados);
		
		JButton DadosNomes = new JButton("Listar Nomes");
		...
		DadosNomes.setBounds(75, 15, 122, 21);
		...
		deletar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(tableDados.getSelectedRow() !=-1) {
					...
					//pb.setIdPessoa = (int)tableDados.getValueAt(tableDados.getSelectedRow(),0);
					pd.deletePessoa(pb);
				}
			}
		});
		deletar.setBounds(438, 15, 85, 21);
		panel6.add(deletar);
	}
}
